  ...
  function renderLobby() {
    container.innerHTML = `
      ...
      <div class="lobby-hero">
        <!-- Timed Quiz Card -->
        <div class="lobby-btn-card card-glow stagger-item" id="btn-quiz-mode">
        ...
        <!-- Formula Sprint Card -->
        <div class="lobby-btn-card card-glow stagger-item" id="btn-sprint-mode" style="border-color: rgba(245, 158, 11, 0.25);">
        ...
        <div class="lobby-btn-card card-glow stagger-item" onclick="alert('Challenge Active: Solve the board exam sample! Redirecting you...'); document.getElementById('btn-quiz-mode').click();" style="border-color: rgba(16, 185, 129, 0.25);">
        ...
        <!-- Topic Battle Card -->
        <div class="lobby-btn-card card-glow stagger-item" onclick="alert('Multiplayer Topic Battles will launch soon in CBSE prep season! Stay tuned.')" style="border-color: rgba(239, 68, 68, 0.15); opacity: 0.8;">
